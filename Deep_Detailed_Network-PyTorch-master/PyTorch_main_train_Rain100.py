...
from PyTorch_dataset_Rain1400 import Rain1400
...
parser.add_argument(
    '--save_dir',
    type=str,
    default="./model/rain1400_finetune"
)
    ...
    for epoch in range(initial_epoch, args.epoch):
        ...
        with torch.no_grad():
            ...
            for _, batch_eval in enumerate(DLoader_eval):
                ...
                psnr_dn = peak_signal_noise_ratio(
                    img_c,
                    img_dn,
                    data_range=1.0
                )
